      ...
      <div className="relative mx-auto mt-32 max-w-[80rem] px-6 text-center md:px-8">
        ...
        <section className="container mt-24 flex max-w-5xl flex-col gap-8 text-left px-4">
          ...
          <p>
            ...
            chris.watts.t@gmail.com if you have any questions. By using the
          ...
          <p>
            ...
            communications, you may contact us at chris.watts.t@gmail.com. If
            you unsubscribe from our marketing lists you will no longer receive
          ...
          <p>
            Please log in to your account or contact us at
            chris.watts.t@gmail.com if you need to change or correct your
            Personal Data.
          </p>
          ...
          <p>
            ...
            features. You can also contact us at chris.watts.t@gmail.com to ask
            us to update or correct your Personal Data.
          </p>
