...
export function useHubWebSocket(options: UseHubWebSocketOptions = {}) {
  ...
  const [lastMessage, setLastMessage] = useState<HubWebSocketMessage | null>(null);
  ...
  }, [onMessage, onAlertTriggered, onAlertResolved, onError, autoReconnect, reconnectDelay]);
