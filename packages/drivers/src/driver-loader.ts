...
const log = debug('cove:drivers:driver-loader');
...
export class DriverLoader {
  ...
  > {
    ...
    // Point to the drivers directory relative to this file
    const driversDir = path.resolve(import.meta.dir, '.');
